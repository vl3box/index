<template>
    <div class="m-flower m-sideblock">
        <div class="m-flower-header m-sideblock-header">
            ...
            >
            <a href="/tool/?pid=20274#/" class="u-crop" target="_blank">❤️ 游戏内查询花价 <img src="../assets/img/new2.gif"></a>
        </div>
...
import { __iconPath,__ossMirror } from "@jx3box/jx3box-common/data/jx3box.json";
