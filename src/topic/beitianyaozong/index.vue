        ...
        <div class="p-topic-container">
            <div class="wp shadow">
                ...
                <div class="m-topic-header">
                    <img class="u-textImg p-animation fadeInRight" :src="btyz + `yaozong.png`" />
                </div>
                <!-- 专题内容 -->
                <div class="m-topic-content" ref="scrollShow">
                    ...
                    >
                        <img class="u-textImg p-animation fadeInRight" :src="btyz + `txtr.png`" />
                        <div class="u-sleeve"></div>
                        <div class="u-video" v-html="video"></div>
                    </div>
                    <!-- 药宗介绍和链接 -->
                    <div class="m-topic-info" :class="infinite ? 'infinite' : ''">
                        <img class="u-textImg p-animation fadeInDown" :src="btyz + `txt.png`" />
                        <div class="u-btnbox">
                            <a
                    ...
                    <!-- pve -->
                    <div class="m-topic-block m-topic-pve" :class="infinite ? 'infinite' : ''">
                        <img class="u-title p-animation fadeInDown" :src="btyz + `one.png`" />
                    ...
                    <div class="m-topic-block m-topic-pvp">
                        <img class="u-title p-animation fadeInDown" :src="btyz + `two.png`" />
                        <div class="u-cont">
                            <a
                    ...
                    <div class="m-topic-block m-topic-pvx">
                        <img class="u-title p-animation fadeInDown" :src="btyz + `three.png`" />
                        <div class="u-cont p-animation fadeInDown">
                            <div class="u-swiper">
    ...
    methods: {
        ...
        showAnimation() {
            ...
            for (let i = 0; i < dom.children.length; i++) {
                if (
                    dom.children[i].getBoundingClientRect().top -
